...
<head>
    ...
    <title>Admin Display Instructor</title>
        ...
        <table class="table">
            ...
            <tbody>
                <%
                    ...
                    ArrayList<Account> instructorAccountList = adao.getAllInstructors();

                    for (Account a : instructorAccountList) {
                %>
                <tr>
                    <td><%= a.getUserid() %></td>
                    <td><%= a.getUsername() %></td>
                    ...
                    <td><%= a.getRole() %></td>
                    <td>
                        <a href="AdminEditInstructorPage.jsp?userid=<%= a.getUserid() %>" class="btn btn-sm btn-edit">Edit</a>
